...
<head>
	...
	<title>后盾微博-注册</title>
	<link rel="stylesheet" href="/weibo/APP/Home/Public/Css/regis.css" />
	<script type="text/javascript" src="/weibo/APP/Home/Public/Js/jquery-1.7.2.min.js"></script>
	<script type="text/javascript" src="/weibo/APP/Home/Public/Js/jquery-validate.js"></script>
	<script type='text/javascript'>
		var checkAccount = "<?php echo U('checkAccount');?>";
		var checkUname = "<?php echo U('checkUname');?>";
		var checkVerify = "<?php echo U('checkVerify');?>";
	</script>
	<script type="text/javascript" src="/weibo/APP/Home/Public/Js/register.js"></script>
</head>
<body>
	<div id='logo'></div>
	<div id='reg-wrap'>
		<form action="" method='' name='register'>
			<fieldset>
				...
				<p>
					...
					<img src="<?php echo U('Login/verify','','');?>" width='80' height='25' id='verify-img'/>
				</p>
				<p class='run'>
